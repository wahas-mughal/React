...
function AddTransaction() {
  const [text, setText] = useState(""); //set description in the expense state by setExpense function
    ...
    <div className = "add-transaction">
      ...
      <form onSubmit={onSubmit}>
        <div className="form-control">
          ...
          <input
            type="text"
            value={text} // set the input value
            placeholder="Enter your expense..."
            onChange={(e) => setText(e.target.value)} //Read the value from the input as it change and set the state 
          />
        </div>
        <div className="form-control">
